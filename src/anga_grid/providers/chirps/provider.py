...
from anga_grid.providers.chirps.manifest import apply_manifest, build_manifest
from anga_grid.providers.chirps.schema import (
    PRECIP_CANDIDATES,
    canonicalize,
    find_precip,
)
...
CHIRPS_PRECIP_CANDIDATES = PRECIP_CANDIDATES
...
class CHIRPSProvider:
    ...
    def _open_local(
        ...
        return apply_manifest(ds, build_manifest(self.name, bbox, time_range))
